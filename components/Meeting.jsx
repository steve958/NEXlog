...
export default function Meeting(props) {
    ...
    function saveEvent() {
        ...
        reminderTimeRef.current.value = '30'
        setReminderBool(false)
    }
    ...
    return (
        <div className='flex flex-col'>
            ...
            <span className='flex gap-3 mt-3 justify-between'>
                <span>email</span>
                <select name="select" id="select"
                    ...
                    <option value="30" htmlFor='select'>30</option>
                    <option value="60" htmlFor='select'>60</option>
                    <option value="120" htmlFor='select'>120</option>
                </select>
                <p>minutes before</p>
            </span>
